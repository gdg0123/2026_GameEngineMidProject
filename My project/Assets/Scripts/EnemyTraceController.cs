...
public class EnemyTraceController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Vector2 directionNoramlized = direction.normalized;

        RaycastHit2D[] hits = Physics2D.RaycastAll(transform.position, directionNoramlized, raycastDistance);
        Debug.DrawRay(transform.position, directionNoramlized * raycastDistance, Color.red);
